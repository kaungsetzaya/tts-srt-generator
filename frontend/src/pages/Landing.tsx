...
export default function Landing() {
  ...
  return (
    ...
    >
        ...
        <motion.div style={{ opacity: heroOp }} className="text-center">
          ...
          <div>
            <motion.h1
              ...
              style={{
                fontSize: "clamp(52px, 14vw, 170px)",
      ...
      >
        <div className="max-w-3xl mx-auto">
          <F>
            ...
            >
              <p
                className="text-sm uppercase tracking-[0.5em] font-bold mb-3"
                style={{ color: C.gold }}
              >
                About
              </p>
              <h2
                className="font-black uppercase mb-5 text-2xl md:text-4xl"
      ...
      >
        <div className="max-w-6xl mx-auto">
          <F className="text-center mb-14">
            <p
              className="text-sm uppercase tracking-[0.5em] font-bold mb-2"
              style={{ color: C.gold }}
            >
              Core Features
            </p>
            <h2 className="font-black uppercase text-2xl md:text-4xl">
              Everything You Need
            </h2>
          </F>
          <div
            ...
            {features.map((f, i) => (
              <F key={f.title} delay={i * 0.1}>
                ...
                >
                  ...
                  <span
                    className="text-xs font-bold uppercase tracking-[0.3em] px-2.5 py-1 rounded-full mb-3 w-fit"
                    style={{
            ...
            {steps.map((s, i) => (
              ...
              >
                <motion.div
                  ...
                  className="w-14 h-14 rounded-2xl flex items-center justify-center text-sm font-black mb-4 relative z-10"
                  style={{
                    background: C.glass,
                    backdropFilter: "blur(12px)",
                    border: `1px solid ${C.glassB}`,
                ...
                <h5 className="font-black uppercase text-xs mb-1.5 tracking-wider">
                  {s.t}
                </h5>
                <p
      ...
      <F>
        <section
          className="relative z-10 px-6 md:px-12 py-20 text-center"
          style={{ scrollSnapAlign: "start" }}
        >
          <motion.div
          ...
          >
            ...
            <p className="text-sm mb-8" style={{ color: C.nude }}>
      ...
      <footer
        className="relative z-10 text-center py-8 text-xs tracking-[0.4em] uppercase"
