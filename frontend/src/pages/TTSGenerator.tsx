...
export default function TTSGenerator() {
  ...
  const currentCharLimit = isAdmin
    ? 99999
    : voiceMode === "character"
      ? (planLimits?.charLimitCharacter ?? 0)
      : (planLimits?.charLimitStandard ?? 0);
  ...
  // --- PREMIUM UI COLORS (Modern Blue-Cyan 3D Palette) ---
  const isDark = theme === "dark";

  const accent = "#2563EB";
  const accentSecondary = "#0891B2";
  const deepRed = "#DC2626";
  const peach = "#DBEAFE";
  const cream = "#F0F9FF";
  const darkBrown = "#0F172A";
  ...
  // Light theme: Clean Sky White, Dark: Deep Navy
  const bgGradient = isDark
    ? "linear-gradient(135deg, #0C1222 0%, #1E293B 50%, #0C1222 100%)"
    : "linear-gradient(135deg, #F0F9FF 0%, #EFF6FF 50%, #F8FAFC 100%)";

  // Card backgrounds — glass morphism with depth
  const cardBg = isDark ? "rgba(15,23,42,0.85)" : "rgba(255,255,255,0.85)";
  const cardBorder = isDark ? "rgba(37,99,235,0.2)" : "rgba(37,99,235,0.10)";
  const textColor = isDark ? "#E2E8F0" : "#0F172A";
  const subtextColor = isDark ? "rgba(148,163,184,0.7)" : "#64748B";
  const labelBg = isDark ? "rgba(37,99,235,0.15)" : "rgba(37,99,235,0.08)";
  const inputBg = isDark ? "rgba(15,23,42,0.6)" : "rgba(255,255,255,0.90)";
  const inputBorder = isDark ? "rgba(37,99,235,0.2)" : "rgba(37,99,235,0.15)";

  const box =
    "relative border p-4 md:p-5 pt-8 backdrop-blur-xl transition-all duration-300 rounded-2xl mt-6";
  const boxShadow = isDark
    ? "0 8px 32px rgba(0,0,0,0.4), 0 2px 8px rgba(37,99,235,0.08), inset 0 1px 0 rgba(255,255,255,0.05)"
    : "0 8px 32px rgba(0,0,0,0.08), 0 2px 8px rgba(37,99,235,0.04), inset 0 1px 0 rgba(255,255,255,0.8)";
  const labelStyle =
    ...
    const dubOpts = {
      voice:
        dubVoiceMode === "standard"
          ? dubVoice
          : ((CHARACTER_VOICES_MAP[dubCharacter]?.base || dubVoice) as
              | "thiha"
              | "nilar"),
    ...
    if (dubVideoUrl.trim()) {
      try {
        const res = await startDubMutation.mutateAsync({
          videoBase64: btoa(dubVideoUrl.trim()),
          filename: "video.mp4",
          ...dubOpts,
          srtBlurBg: false,
        });
      ...
      >
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `linear-gradient(0deg, transparent 24%, ${isDark ? "rgba(37,99,235,0.12)" : "rgba(37,99,235,0.15)"} 25%, ${isDark ? "rgba(37,99,235,0.12)" : "rgba(37,99,235,0.15)"} 26%, transparent 27%, transparent 74%, ${isDark ? "rgba(37,99,235,0.12)" : "rgba(37,99,235,0.15)"} 75%, ${isDark ? "rgba(37,99,235,0.12)" : "rgba(37,99,235,0.15)"} 76%, transparent 77%, transparent), linear-gradient(90deg, transparent 24%, ${isDark ? "rgba(37,99,235,0.12)" : "rgba(37,99,235,0.15)"} 25%, ${isDark ? "rgba(37,99,235,0.12)" : "rgba(37,99,235,0.15)"} 26%, transparent 27%, transparent 74%, ${isDark ? "rgba(37,99,235,0.12)" : "rgba(37,99,235,0.15)"} 75%, ${isDark ? "rgba(37,99,235,0.12)" : "rgba(37,99,235,0.15)"} 76%, transparent 77%, transparent)`,
        ...
        <div
          ...
          style={{
            ...
            boxShadow: isDark
              ...
              : "0 1px 12px rgba(8,145,178,0.06)",
          }}
        >
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <motion.button
              ...
              style={{
                border: `1px solid ${isDark ? "rgba(37,99,235,0.35)" : "rgba(37,99,235,0.15)"}`,
                background: isDark
                  ? "rgba(37,99,235,0.1)"
                  ...
                  {dubPreviewUrl && !dubResult && (
                    <div className="space-y-4">
                      ...
                      >
                        <button
                          onClick={() =>
                            setSpeedAccordionOpen(!speedAccordionOpen)
                          }
                          className="w-full flex items-center justify-between"
                          style={{ marginTop: "-4px" }}
                        >
                          ...
                          >
                            {lang === "mm"
                              ? "အမြန်နှုန်း / အသံနိမ့်မြင့်"
                              : "Speed / Pitch"}
                          </div>
                          <ChevronDown
                            className={`w-5 h-5 transition-transform duration-200 ${speedAccordionOpen ? "rotate-180" : ""}`}
                            style={{ color: accent }}
                          />
                        </button>
                        {speedAccordionOpen && (
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2 animate-in fade-in slide-in-from-top-2 duration-200">
                            <div>
                              ...
                              <Slider
                                value={[dubSpeed]}
                                onValueChange={v => setDubSpeed(v[0])}
                                min={0.5}
                                max={2.0}
                                step={0.1}
                                className="w-full"
                            ...
                            <div>
                              ...
                              <Slider
                                value={[dubPitch]}
                                onValueChange={v => setDubPitch(v[0])}
                                min={-20}
                                max={20}
                                step={1}
                                className="w-full"
                        ...
                        {srtAccordionOpen && (
                          <div className="space-y-4 mt-2 animate-in fade-in slide-in-from-top-2 duration-200">
                            <div className="flex items-center justify-between py-2">
                              ...
                              >
                                <span
                                  className={`absolute top-0.5 sm:top-0.5 w-6 h-6 sm:w-5 sm:h-5 rounded-full bg-white transition-all shadow-md ${srtEnabled ? "left-8 sm:left-6" : "left-0.5"}`}
                                />
                              </button>
                            </div>
                              ...
                              >
                                <div>
                                  ...
                                  <div className="flex items-center gap-3">
                                    <Slider
                                      value={[srtFontSize]}
                                      onValueChange={v => setSrtFontSize(v[0])}
                                      min={12}
                                      max={48}
                                      step={1}
                                      className="flex-1"
                                ...
                                <div className="flex items-center justify-between py-1">
                                  ...
                                  <button
                                    onClick={() =>
                                      setSrtDropShadow(!srtDropShadow)
                                    }
                                    className="relative w-11 h-6 rounded-full transition-all"
                                    style={{
                                      background: srtDropShadow
                                        ? accent
                                        : isDark
                                          ? "rgba(255,255,255,0.15)"
                                          : "#d1d5db",
                                  ...
                                  >
                                    <span
                                      className={`absolute top-0.5 w-5 h-5 rounded-full bg-white transition-all shadow ${srtDropShadow ? "left-6" : "left-0.5"}`}
                                    />
                                  </button>
                                </div>
                                ...
                                <div className="flex items-center justify-between py-1">
                                  ...
                                  >
                                    <span
                                      className={`absolute top-0.5 w-5 h-5 rounded-full bg-white transition-all shadow ${srtBlurBg ? "left-6" : "left-0.5"}`}
                                    />
                                  </button>
                                </div>
                                  ...
                                  >
                                    ...
                                    <div className="flex items-center justify-between py-1">
                                      <div>
                                        ...
                                        >
                                          {lang === "mm"
                                            ? "ဘေးတိုက် အစွန်ထိ ပြည့်အောင်"
                                            : "Edge to edge"}
                                        </p>
                                      </div>
                                      <button
                                        onClick={() =>
                                          setSrtFullWidth(!srtFullWidth)
                                        }
                                        className="relative w-11 h-6 rounded-full transition-all"
                                        style={{
                                      ...
                                      >
                                        <span
                                          className={`absolute top-0.5 w-5 h-5 rounded-full bg-white transition-all shadow ${srtFullWidth ? "left-6" : "left-0.5"}`}
                                        />
                                      </button>
                                    </div>
                                    ...
                                    {!srtFullWidth && (
                                      <div>
                                        ...
                                        <div className="flex gap-2">
                                          ...
                                          <button
                                            onClick={() =>
                                              setSrtBorderRadius("square")
                                            }
                                            className="flex-1 py-2 px-3 rounded-xl border-2 text-xs font-bold transition-all"
                                            style={{
                                              borderColor:
                                                srtBorderRadius === "square"
                                                  ? accent
                                                  : cardBorder,
                                              background:
                                                srtBorderRadius === "square"
                                ...
                                <div>
                                  ...
                                  <div className="flex items-center gap-3">
                                    <span className="text-[10px] opacity-50">
                                      {lang === "mm" ? "အောက်" : "Bottom"}
                                    </span>
                                    <Slider
                                      value={[srtMarginV]}
                                      onValueChange={v => setSrtMarginV(v[0])}
                                      min={5}
                                      max={200}
                                      step={5}
                                      className="flex-1"
          ...
          {secondaryTab === "plan" && (
            <div className="max-w-3xl mx-auto py-4 sm:py-8 animate-in fade-in zoom-in-95 duration-300">
              ...
              <div
                ...
                style={{
                  background: `linear-gradient(135deg, ${isDark ? "rgba(37,99,235,0.15)" : "rgba(37,99,235,0.05)"}, ${cardBg})`,
