...
// ── Accent colors ──────────────────────────────────────────────
const C = "#2563EB"; // royal blue
const C_GOLD = "#0891B2"; // cyan
const C_BG = "#0C1222"; // dark background
const cardBg = "rgba(15,23,42,0.8)"; // card background
const border = "rgba(37,99,235,0.25)";
      ...
      {showSubModal && (
        ...
        >
          <div
            ...
            style={{ background: C_CARD, borderColor: border }}
            onClick={e => e.stopPropagation()}
          >
            <h3
