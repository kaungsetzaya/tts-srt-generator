    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6 py-24">
        ...
        >
          ...
          >
            Simple, <span style={{ color: "#F4B34F" }}>Credit-Based</span>{" "}
            Pricing
          </h1>
          <p className="text-lg opacity-60 max-w-xl mx-auto">
            Pay for what you use. Buy credits and use them across all features.
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow: plan.popular
                  ? "0 20px 60px rgba(192,111,48,0.2)"
                  : "none",
              }}
            >
              {/* Badge */}
              ...
              <div className="text-center mb-8">
                ...
                <div
                  ...
                  style={{
                    ...
                    border: "1px solid rgba(244,179,79,0.3)",
                  }}
                >
        ...
        >
          ...
          <p className="text-center text-sm opacity-40 mt-4">
            Trial users get{" "}
            <span className="font-bold" style={{ color: "#F4B34F" }}>
              10 free credits
            </span>{" "}
            to start
          </p>
        ...
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(192,111,48,0.12) 0%, rgba(244,179,79,0.06) 100%)",
            border: "1px solid rgba(192,111,48,0.2)",
          }}
        >
          <Crown
          ...
          <button
            ...
            style={{ background: "#F4B34F", color: "#0f0f0f" }}
          >
            Contact Sales
          </button>
        </motion.div>
