...
export function securityHeaders(req: Request, res: Response, next: NextFunction) {
  ...
  ensureDirective("img-src", "'self'", "data:", "blob:", "https:", "*.r2.cloudflarestorage.com", "lumixstudio.cc", "https://*.fbcdn.net", "https://*.facebook.com", "https://fb.watch", "tiktok.com", "youtube.com");
