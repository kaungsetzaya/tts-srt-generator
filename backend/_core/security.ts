...
export function securityHeaders(req: Request, res: Response, next: NextFunction) {
  ...
  ensureDirective("img-src", "'self'", "data:", "blob:", "https://*.fbcdn.net", "https://*.facebook.com", "https://fb.watch", "https://*.fna.fbcdn.net", "https://scontent.xx.fbcdn.net", "*.r2.cloudflarestorage.com", "lumixstudio.cc", "tiktok.com", "youtube.com");
