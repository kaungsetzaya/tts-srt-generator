...
export function securityHeaders(req: Request, res: Response, next: NextFunction) {
  ...
  ensureDirective("img-src", "'self'", "data:", "blob:", "https:", "*.r2.cloudflarestorage.com", "lumixstudio.cc", "https://*.facebook.com", "https://*.fbcdn.net", "tiktok.com", "youtube.com");
  ...
  ensureDirective("connect-src", "'self'", "https:", "*.r2.cloudflarestorage.com", "lumixstudio.cc", "https://*.facebook.com", "https://*.fbcdn.net", "tiktok.com", "youtube.com", "googlevideo.com");
